const openapi = {
  ...
  "x-wanted-root-envelope": { version: "0.2-RE1", batch_verification_profile: "0.2-REB1", batch_conformance_profile: "0.2-REBC1", sdk_version: "0.4-RES3", certification_effect: "hard_field_gate", ranking_effect: "eligibility_only_not_score_or_tiebreaker", audit_manifest_field: "root_envelope_integrity", audit_verification_profile: "0.2-REB1", audit_evidence_role: "root_envelope_verification_report", guide: "/wanted-10k/root-commitment-witness/envelopes", module: "/wanted-10k/wanted-root-envelope.mjs", contract: "/wanted-10k/root-envelope.json", sdk_contract: "/wanted-10k/root-envelope-sdk.json", schema: "/wanted-10k/root-envelope.schema.json", batch_schema: "/wanted-10k/root-envelope-batch.schema.json", conformance_vectors: "/wanted-10k/root-envelope-conformance-vectors.json", conformance_vector_count: 10, audit_manifest_schema: "/wanted-10k/audit-manifest.schema.json", template: "/wanted-10k/root-envelope.template.json", telemetry_verifier_dependency: "/wanted-10k/wanted-telemetry-verifier.mjs", performs_network_requests: false, cli_modes: ["create", "verify", "verify-series", "verify-batch", "conformance-batch"] },
