const openapi = {
  ...
  "x-wanted-root-envelope": { version: "0.2-RE1", sdk_version: "0.2-RES1", certification_effect: "hard_field_gate", ranking_effect: "eligibility_only_not_score_or_tiebreaker", audit_manifest_field: "root_envelope_integrity", audit_evidence_role: "root_envelope_verification_report", guide: "/wanted-10k/root-commitment-witness/envelopes", module: "/wanted-10k/wanted-root-envelope.mjs", contract: "/wanted-10k/root-envelope.json", sdk_contract: "/wanted-10k/root-envelope-sdk.json", schema: "/wanted-10k/root-envelope.schema.json", audit_manifest_schema: "/wanted-10k/audit-manifest.schema.json", template: "/wanted-10k/root-envelope.template.json", telemetry_verifier_dependency: "/wanted-10k/wanted-telemetry-verifier.mjs", performs_network_requests: false, cli_modes: ["create", "verify", "verify-series"] },
