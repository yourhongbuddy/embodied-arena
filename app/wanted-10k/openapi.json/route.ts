const openapi = {
  ...
  "x-wanted-telemetry-verifier": { version: "0.2-TS2", module: "/wanted-10k/wanted-telemetry-verifier.mjs", contract: "/wanted-10k/telemetry-verifier-sdk.json", performs_network_requests: false, cli_exit_codes: { pass: 0, verification_failed: 1, usage_or_io_error: 2 } },
