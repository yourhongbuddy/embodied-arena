const spec = {
  ...
  cohort: {
    ...
    rankability_requires: ["cohort_integrity_0.2-E1_passed", "rmst_identifiable_at_10000", "bootstrap_interval_available", "safety_gate_passed", "independent_audit_complete"],
  },
  ...
  certification_profile: {
    ...
    targets: {
      PREQUALIFIED: { environment: "simulation_only", minimum_resident_hours: 0, required: ["preflight_0.2-P1", "simulation_report"], not_applicable: ["cohort_integrity_0.2-E1", "primary_W", "field_diagnostics", "field_safety", "field_telemetry", "endpoint_adjudication"] },
      WANTED_LAB: { inherits: "PREQUALIFIED", minimum_independent_environments: 1, minimum_resident_hours: 100, required: ["cohort_integrity_0.2-E1", "field_safety_0.2-S1", "signed_telemetry", "diagnostics_0.2-D1", "endpoint_adjudication", "lab_report"], not_applicable: ["primary_W"] },
  ...
  certification_handoff: {
    ...
    binds: ["preregistration", "robot_versions", "preflight", "cohort_summary", "cohort_integrity", "primary_score", "diagnostics", "safety_evidence", "telemetry_commitments", "endpoint_adjudication", "withdrawal_results", "independent_audit"],
