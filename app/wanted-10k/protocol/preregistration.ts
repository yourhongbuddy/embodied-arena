export const preregistrationSchema = {
  ...
  properties: {
    ...
    telemetry: { type: "object", additionalProperties: false, required: ["schema_version", "authenticity_profile", "canonicalization", "hash", "signature_algorithm", "signature_scope", "public_key_or_certificate", "root_commit_interval_hours", "clock_sync"], properties: {
      schema_version: { const: "0.2" }, authenticity_profile: { const: "0.2-T1" }, canonicalization: { const: "RFC8785_JCS" }, hash: { const: "SHA-256" }, signature_algorithm: { const: "Ed25519" }, signature_scope: { const: "current_event_without_signature" }, public_key_or_certificate: { type: "string", minLength: 1 }, root_commit_interval_hours: { type: "number", exclusiveMinimum: 0, maximum: 168 }, clock_sync: { type: "string", minLength: 1 },
    } },
    analysis: { type: "object", additionalProperties: false, required: ["horizon_hours", "estimator", "primary_score", "bootstrap_unit", "bootstrap_samples", "bootstrap_seed", "bootstrap_prng", "bootstrap_index_mapping", "identifiability_rule", "censoring_sensitivity", "leave_one_environment_out", "influence_review_threshold_w_points", "tail_support_reported", "material_version_strata", "missing_data", "subgroups"], properties: {
      horizon_hours: { const: 10000 }, estimator: { const: "Kaplan-Meier" }, primary_score: { const: "normalized_RMST" }, bootstrap_unit: { const: "environment" }, bootstrap_samples: { type: "integer", minimum: 10000 }, bootstrap_seed: { type: "integer" }, bootstrap_prng: { const: "pcg32_xsh_rr_64_32_seeded_v1" }, bootstrap_index_mapping: { const: "high_32_bits_of_uint32_times_n" }, identifiability_rule: { const: "no_extrapolation_beyond_observed_support_while_survival_above_zero" }, censoring_sensitivity: { const: "immediate_rejection_vs_horizon_retention_bounds" }, leave_one_environment_out: { const: true }, influence_review_threshold_w_points: { type: "number", exclusiveMinimum: 0 }, tail_support_reported: { const: true }, material_version_strata: { type: "array", minItems: 1, items: { type: "string" } }, missing_data: { type: "string", minLength: 1 }, subgroups: { type: "array", items: { type: "string" } },
    } },
...
export const preregistrationTemplate = {
  ...
  telemetry: { schema_version: "0.2", authenticity_profile: "0.2-T1", canonicalization: "RFC8785_JCS", hash: "SHA-256", signature_algorithm: "Ed25519", signature_scope: "current_event_without_signature", public_key_or_certificate: "[Public 0.2-T1 key manifest URL]", root_commit_interval_hours: 24, clock_sync: "[UTC source, drift threshold, and correction policy]" },
  analysis: { horizon_hours: 10000, estimator: "Kaplan-Meier", primary_score: "normalized_RMST", bootstrap_unit: "environment", bootstrap_samples: 10000, bootstrap_seed: 10000, bootstrap_prng: "pcg32_xsh_rr_64_32_seeded_v1", bootstrap_index_mapping: "high_32_bits_of_uint32_times_n", identifiability_rule: "no_extrapolation_beyond_observed_support_while_survival_above_zero", censoring_sensitivity: "immediate_rejection_vs_horizon_retention_bounds", leave_one_environment_out: true, influence_review_threshold_w_points: 5, tail_support_reported: true, material_version_strata: ["hardware_version", "policy_version", "support_model_version"], missing_data: "[Missingness detection and disposition]", subgroups: ["[Preregistered subgroup only]"] },
