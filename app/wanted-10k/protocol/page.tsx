...
const kit = [
  ...
  ["SIGNED ROOT ENVELOPES", "Define exactly what each witnessed digest commits to: a verified signed telemetry prefix, frozen keys, coverage boundary, counts, tail, and prior root.", "/wanted-10k/root-commitment-witness/envelopes", "OPEN ROOT ENVELOPE GUIDE →"],
