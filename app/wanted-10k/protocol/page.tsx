...
const kit = [
  ...
  ["ROOT ENVELOPE SDK CONTRACT", "Pin helper version 0.3-RES2, the telemetry-verifier dependency, source digest, single, series, and batch CLI modes, bindings, and privacy boundary.", "/wanted-10k/root-envelope-sdk.json", "OPEN ENVELOPE SDK ↗"],
