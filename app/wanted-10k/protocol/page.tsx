...
const kit = [
  ...
  ["ROOT ENVELOPE SDK CONTRACT", "Pin helper version 0.2-RES1, the telemetry-verifier dependency, source digest, CLI modes, bindings, and privacy boundary.", "/wanted-10k/root-envelope-sdk.json", "OPEN ENVELOPE SDK ↗"],
