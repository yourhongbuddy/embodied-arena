...
const kit = [
  ...
  ["ANALYSIS CONFORMANCE VECTORS", "Run eight normative 0.2-AC3 cases with exact outputs for the A2 estimator, tie rule, horizon boundary, terminal causes, independent units, and full-horizon completion.", "/wanted-10k/analysis-conformance-vectors.json", "DOWNLOAD VECTORS ↓"],
  ...
  ["ANALYSIS CONFORMANCE RUNNER", "Execute the entire 0.2-AC3 pack with a zero-dependency ESM module and receive field-level mismatch reports.", "/wanted-10k/wanted-analysis-conformance.mjs", "DOWNLOAD RUNNER ↓"],
  ["ANALYSIS RUNNER CONTRACT", "Pin runner version 0.2-ACS3, exported functions, source digest, vector-pack digest, and the non-certification boundary.", "/wanted-10k/analysis-conformance-sdk.json", "OPEN CONTRACT ↗"],
