...
const kit = [
  ...
  ["ANALYSIS CONFORMANCE VECTORS", "Run six normative 0.2-AC2 edge cases with exact outputs for the A2 estimator, tie rule, horizon boundary, and terminal-cause refusal paths.", "/wanted-10k/analysis-conformance-vectors.json", "DOWNLOAD VECTORS ↓"],
  ...
  ["ANALYSIS CONFORMANCE RUNNER", "Execute the entire 0.2-AC2 pack with a zero-dependency ESM module and receive field-level mismatch reports.", "/wanted-10k/wanted-analysis-conformance.mjs", "DOWNLOAD RUNNER ↓"],
  ["ANALYSIS RUNNER CONTRACT", "Pin runner version 0.2-ACS2, exported functions, source digest, vector-pack digest, and the non-certification boundary.", "/wanted-10k/analysis-conformance-sdk.json", "OPEN CONTRACT ↗"],
