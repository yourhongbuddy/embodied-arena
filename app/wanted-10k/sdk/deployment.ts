...
export const deploymentSchema = {
  ...
  properties: {
    ...
    signing: { type: "object", additionalProperties: false, required: ["algorithm", "key_id", "public_key_uri", "public_key_sha256", "private_key_exportable"], properties: { algorithm: { enum: ["Ed25519", "ECDSA-P256-SHA256"] }, key_id: { type: "string", minLength: 1, maxLength: 128 }, public_key_uri: uri, public_key_sha256: digest, private_key_exportable: { const: false } } },
...
export const deploymentTemplate = {
  ...
  signing: { algorithm: "Ed25519", key_id: "[Preregistered key identifier]", public_key_uri: "https://example.org/wanted-public-key.jwk", public_key_sha256: "[64 lowercase hexadecimal characters]", private_key_exportable: false },
