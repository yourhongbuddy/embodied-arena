...
const auditManifestTemplateBase = {
  ...
  audit: { profile_version: "0.2-V1", auditor: "Synthetic Auditor", auditor_organization: "Independent Example Assurance", independence_statement: "Synthetic example: auditor is organizationally and financially independent of the sponsor.", scope: ["Preregistration freeze and amendment integrity", "Prospective sampling and stopping integrity", "Protocol deviation reconciliation", "Telemetry continuity", "Endpoint dispositions", "Safety evidence", "Score reproduction", "Site heterogeneity and dominance", "Withdrawal integrity", "Human measures integrity", "Learning and generalization integrity", "Assistance integrity", "Policy evolution integrity", "Privacy and consent integrity", "Service continuity integrity"], signed_at: "2026-08-28T18:00:00Z", signature_algorithm: "Ed25519", canonicalization: "RFC8785_JCS", signature_scope: "audit_manifest_without_audit.manifest_sha256_and_audit.auditor_signature", public_key_uri: "https://embodied-arena.chrishongap.chatgpt.site/wanted-10k/auditor-credential.template.json", public_key_base64url: "11qYAYKxCrfVS_7TyWQHOg7hcvPapiMlrwIaaPcHURo", public_key_sha256: "21fe31dfa154a261626bf854046fd2271b7bed4b6abe45aa58877ef47f9721b9", credential: auditorCredentialTemplate, manifest_sha256: hash("a1"), auditor_signature: "A".repeat(86) },
};

const na = (reason: string) => ({ applicable: false as const, reason });
const syntheticAuditSeals = {
  PREQUALIFIED: { manifest_sha256: "38e3698e952565dd4831fbc74dcd3dce2abd999f597259592ea01988032f743f", auditor_signature: "B5UY4_bn5rH7x_ipMuygRmxaxhjgRcH5BvCY7_4n64fzsoMdzv6GEnhasohxILsttaaRDJ5OVRCMgybO1VKNCg" },
  WANTED_LAB: { manifest_sha256: "d6d53f28d8fbc75004db75acc8a9d18e5a30a642891ba338bb270567d24cc8a3", auditor_signature: "Ky3CfHK7mcWKjWzrMvje-C_19cdtMTsJyTRHO_sDxc2V6mCO5T20bnk0rWQZbHMY4w_popboQU9MFTBIk6bJAg" },
  WANTED_WILD: { manifest_sha256: "516a1def714a8f71bac94990924b5cce740c7d2269703c9aefa3fed5cfbe176e", auditor_signature: "_8hXCLEj9RRj4hNGmwOoPjhXw1uPCSi_sjHPhuFOTQji0yyytn_F_2arU41RQm8e6IANXxu4XAdYKoSSyzILAw" },
  WANTED_10K: { manifest_sha256: "4c3a26d27acbe59a8d56a712a3a8cba3d32e7b87afce7acf8ba975875e81e891", auditor_signature: "hk_cSLMFaYkFQMt3KNEhKap9ATjZDStqAel-IHvQxp1sc54x5kDvb-nE49aNsr8Xmip1Osi94CR_4a9i-gvRBw" },
};
