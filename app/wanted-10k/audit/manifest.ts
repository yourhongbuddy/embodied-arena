...
export const auditManifestSchema = {
  ...
  required: ["protocol_version", "submission_mode", "submission", "organization", "robot", "study", "preflight", "cohort", "cohort_integrity", "exposure_integrity", "analysis_reproduction", "primary", "human_measures", "learning_generalization", "diagnostics", "safety", "telemetry", "adjudication", "withdrawal", "evidence", "privacy", "audit"],
  properties: {
  ...
  allOf: [
    {
      ...
      then: { properties: {
        ...
        cohort_integrity: notApplicable, exposure_integrity: notApplicable, analysis_reproduction: notApplicable, primary: notApplicable, human_measures: notApplicable, learning_generalization: notApplicable, diagnostics: notApplicable, safety: notApplicable, telemetry: notApplicable, adjudication: notApplicable,
...
const auditManifestTemplateBase = {
  ...
  diagnostics: { profile_version: "0.2-D1", ...diagnosticMetrics, learning_delta: null, generalization: { ratio: null, familiar: null, novel: null } },
  ...
  audit: { profile_version: "0.2-V1", auditor: "Synthetic Auditor", auditor_organization: "Independent Example Assurance", independence_statement: "Synthetic example: auditor is organizationally and financially independent of the sponsor.", scope: ["Preregistration", "Telemetry continuity", "Endpoint dispositions", "Safety evidence", "Score reproduction", "Withdrawal integrity", "Human measures integrity", "Learning and generalization integrity"], signed_at: "2026-08-28T18:00:00Z", signature_algorithm: "Ed25519", canonicalization: "RFC8785_JCS", signature_scope: "audit_manifest_without_audit.manifest_sha256_and_audit.auditor_signature", public_key_uri: "https://embodied-arena.chrishongap.chatgpt.site/wanted-10k/auditor-credential.template.json", public_key_base64url: "11qYAYKxCrfVS_7TyWQHOg7hcvPapiMlrwIaaPcHURo", public_key_sha256: "21fe31dfa154a261626bf854046fd2271b7bed4b6abe45aa58877ef47f9721b9", credential: auditorCredentialTemplate, manifest_sha256: hash("a1"), auditor_signature: "A".repeat(86) },
};

const na = (reason: string) => ({ applicable: false as const, reason });
const syntheticAuditSeals = {
  PREQUALIFIED: { manifest_sha256: "80bccbf32d8cab24270f1feea334507e7840191f2a241f235219c60381d81cbd", auditor_signature: "FvyoKC5M4cojz7jw6_CB5A3_m_8RtqYONp_IiwdXwuD_3Y8zelP9PShCliU_OXTcZ34EH1stl1ZDBlzl72fPAQ" },
  WANTED_LAB: { manifest_sha256: "45db7f3d773e2d44fa2a678a133ad2bc258995fb5775dd65f88a44cfbed98c70", auditor_signature: "7o0sIuKwnCoHGKbo9xnouM01m66KV_6d5ntOj7aMbemp-iOQBZeTYpCWjTCQ4zNdu920tBICnJg7XEjscpMeCg" },
  WANTED_WILD: { manifest_sha256: "b024b9c605491a44948f2dbccd3a6811bc32da165a0ec46de757d245d2d875b7", auditor_signature: "kPzgkyUY6PcRpWpKanB6-aZZUdZ7BRIhfiVXQCoDcMKCJF9gKmMeRfvZ3sBurkreFuj7n1se7oNJo5WLeBqVDA" },
  WANTED_10K: { manifest_sha256: "683fd0b8d69f2abdc8ddb80f6feaea593cfa7e53bc5f703f4e1cbbae29f1409a", auditor_signature: "Rf49Tdf143yV0i0ZlLnQNxCFjlF7nf1eWJiBFHQRiQhNVa6cvSGlUfoSFKF5VTaRrmaZZt6h0i8eHZQXDIM9Dw" },
};
