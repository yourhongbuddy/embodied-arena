...
const rootEnvelopeIntegritySummary = { type:"object",additionalProperties:false,required:["profile_version","status","target_certification","manifest_uri","manifest_sha256","root_commitments_sha256","deployment_count","root_count","verified_envelopes","verified_signed_prefixes","missing_envelopes","invalid_envelopes","prefix_binding_failures","key_manifest_mismatches","chain_failures","cadence_failures","qualified_assessor","assessor_attested"],properties:{profile_version:{const:"0.2-RE1"},status:{const:"passed"},target_certification:{enum:["WANTED_LAB","WANTED_WILD","WANTED_10K"]},manifest_uri:uri,manifest_sha256:digest,root_commitments_sha256:digest,deployment_count:{type:"integer",minimum:1},root_count:{type:"integer",minimum:1},verified_envelopes:{type:"integer",minimum:1},verified_signed_prefixes:{type:"integer",minimum:1},missing_envelopes:{const:0},invalid_envelopes:{const:0},prefix_binding_failures:{const:0},key_manifest_mismatches:{const:0},chain_failures:{const:0},cadence_failures:{const:0},qualified_assessor:{type:"string",minLength:1},assessor_attested:{const:true}}};
...
const syntheticAuditSeals = {
  ...
  WANTED_LAB: { manifest_sha256: "b1433aa7f4ddb2fcfceeb9571032fbec8927665fb909fabcdf3639ff2d4b59e7", auditor_signature: "1FXzJUzTahPvd_uAX4UZhjagys87ypZqxbB4P009DHz9H0TGXdKGUaOYlVbIDK8Bb5B0OHo31MRxIC6-FP8yDQ" },
  WANTED_WILD: { manifest_sha256: "a27600cbb78793be4d95aef56d7103cf637bde542274958124d6cca5c274fa9e", auditor_signature: "vZDMZK6WmLmLCC4RWYQ8CJMGNUfSFhjt4U252CPiNvrN3N3pWoUMXc0WpqMTCEHaSC1Qh2DNW5G1K_M4XtOPBg" },
  WANTED_10K: { manifest_sha256: "7ade4c75615b9ce2689ca6da73058cb127db47310e367ac0f45f85096847d347", auditor_signature: "sj2AnyfHtFdSIf_dB0YsgSKT7qNb3qrkgfVVbDrELDlETM0JqKsA9jACTbrhTVybKzVkrGRETHN4lExEQ7dTAA" },
};
