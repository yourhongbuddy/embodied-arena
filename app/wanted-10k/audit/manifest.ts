...
export const auditManifestSchema = {
  ...
  required: ["protocol_version", "submission_mode", "submission", "organization", "robot", "study", "preflight", "cohort", "cohort_integrity", "exposure_integrity", "analysis_reproduction", "primary", "human_measures", "learning_generalization", "assistance_integrity", "policy_evolution_integrity", "diagnostics", "safety", "telemetry", "adjudication", "withdrawal", "evidence", "privacy", "audit"],
  properties: {
...
function diagnosticsWithAssistance(summary: ReturnType<typeof assistanceIntegrityAuditSummary>) {
  return { profile_version: "0.2-D1", ...diagnosticMetrics, learning_delta: null, generalization: { ratio: null, familiar: null, novel: null }, assistance_minutes_per_100_hours: summary.assistance_minutes_per_100_hours, mean_time_between_human_rescue: { estimate_hours: summary.mean_time_between_human_rescue_hours, no_event_lower_bound_hours: summary.no_rescue_lower_bound_hours, events: summary.rescue_events, exposure_hours: summary.resident_hours } };
}
...
const auditManifestTemplateBase = {
  ...
  diagnostics: diagnosticsWithAssistance(assistanceIntegritySummaryValue),
  ...
  audit: { profile_version: "0.2-V1", auditor: "Synthetic Auditor", auditor_organization: "Independent Example Assurance", independence_statement: "Synthetic example: auditor is organizationally and financially independent of the sponsor.", scope: ["Preregistration", "Telemetry continuity", "Endpoint dispositions", "Safety evidence", "Score reproduction", "Withdrawal integrity", "Human measures integrity", "Learning and generalization integrity", "Assistance integrity", "Policy evolution integrity"], signed_at: "2026-08-28T18:00:00Z", signature_algorithm: "Ed25519", canonicalization: "RFC8785_JCS", signature_scope: "audit_manifest_without_audit.manifest_sha256_and_audit.auditor_signature", public_key_uri: "https://embodied-arena.chrishongap.chatgpt.site/wanted-10k/auditor-credential.template.json", public_key_base64url: "11qYAYKxCrfVS_7TyWQHOg7hcvPapiMlrwIaaPcHURo", public_key_sha256: "21fe31dfa154a261626bf854046fd2271b7bed4b6abe45aa58877ef47f9721b9", credential: auditorCredentialTemplate, manifest_sha256: hash("a1"), auditor_signature: "A".repeat(86) },
};

const na = (reason: string) => ({ applicable: false as const, reason });
const syntheticAuditSeals = {
  PREQUALIFIED: { manifest_sha256: "ce37b5f960fe819e3200f72a9237484cb252a115522e99d98946b6903f6c9616", auditor_signature: "yo8ZybYQIKfiM20Xa9r5CpdKevmuXFMzRTuH4IQpz9qLChHpk2wWnFi_alEu7T2DdKuEobNC6CljH4pvlo3vAw" },
  WANTED_LAB: { manifest_sha256: "93851ca7367ce371edc6a7ec405b8278b527dfd0dee301ef7a6d23191f6ccd20", auditor_signature: "evHgkbR3OZ0_DEf2Ehm-7sE9nirrNAXP4BcNvaT6ZJ6YTpOVCVy7r_q7qjjtK4x1ogYeeJo214cIgxIvGdr2AQ" },
  WANTED_WILD: { manifest_sha256: "3785ef194f4d29ed840b260a902f9da98e82f7627dacdc4135bdf339438f9d82", auditor_signature: "1haGtCc0DngBrydsFXuzKeVWupeEkT1J0YFbb2oIjQONRNhY9XZyGhuHNzTobAwGIxG7JF5dHD28mmzuppwfCQ" },
  WANTED_10K: { manifest_sha256: "677cb6f6abf7aa7dc9f78f7c5a11ed972ef2d2b9965413317a023061936d1163", auditor_signature: "orGg-vKuvKKCdak-AxSaTBDgC12klb50lA8bObiec8kZkoLAUuzYZ76FKRJEA7F4RZJe0WRy6QzodzFb0WzBCQ" },
};
...
export function auditManifestTemplateFor(target: "PREQUALIFIED" | "WANTED_LAB" | "WANTED_WILD" | "WANTED_10K") {
  ...
  if (target === "WANTED_LAB") {
    ...
    value.diagnostics = diagnosticsWithAssistance(value.assistance_integrity);
