...
export const auditManifestSchema = {
  ...
  required: ["protocol_version", "submission_mode", "submission", "organization", "robot", "study", "preflight", "cohort", "cohort_integrity", "exposure_integrity", "analysis_reproduction", "primary", "human_measures", "learning_generalization", "assistance_integrity", "diagnostics", "safety", "telemetry", "adjudication", "withdrawal", "evidence", "privacy", "audit"],
  properties: {
...
const auditManifestTemplateBase = {
  ...
  audit: { profile_version: "0.2-V1", auditor: "Synthetic Auditor", auditor_organization: "Independent Example Assurance", independence_statement: "Synthetic example: auditor is organizationally and financially independent of the sponsor.", scope: ["Preregistration", "Telemetry continuity", "Endpoint dispositions", "Safety evidence", "Score reproduction", "Withdrawal integrity", "Human measures integrity", "Learning and generalization integrity", "Assistance integrity"], signed_at: "2026-08-28T18:00:00Z", signature_algorithm: "Ed25519", canonicalization: "RFC8785_JCS", signature_scope: "audit_manifest_without_audit.manifest_sha256_and_audit.auditor_signature", public_key_uri: "https://embodied-arena.chrishongap.chatgpt.site/wanted-10k/auditor-credential.template.json", public_key_base64url: "11qYAYKxCrfVS_7TyWQHOg7hcvPapiMlrwIaaPcHURo", public_key_sha256: "21fe31dfa154a261626bf854046fd2271b7bed4b6abe45aa58877ef47f9721b9", credential: auditorCredentialTemplate, manifest_sha256: hash("a1"), auditor_signature: "A".repeat(86) },
};

const na = (reason: string) => ({ applicable: false as const, reason });
const syntheticAuditSeals = {
  PREQUALIFIED: { manifest_sha256: "a8a167933517b423a523a6889c084acc2ae12e8d8b235db8aee732afde060cbc", auditor_signature: "hh2mJ5svExSH2WWFGd73MCApNgfkYkSMX3O6903J3_WYSaz17nX-U3QFcEKt_ImG0CbvcyHCngFfhC1ahIXjDw" },
  WANTED_LAB: { manifest_sha256: "166f7e32bbdd39bf9bc9ae04c47a0d8ac44faeec933fdf16eb4b2af59a60c316", auditor_signature: "V-RVUFrCpqkTkbvv7dmKCh7_gLaFR1dkgjPRbfLziqaXeOAoY6MuqVNqRTVrF3XlwtjRPGKdcGRirig2hx7rDQ" },
  WANTED_WILD: { manifest_sha256: "514a03b61d6618307e0c4d554c4352b164c747919e4a3606896b5d707c85cc9c", auditor_signature: "grNGfe4AVMuSed43OKKpIwxXz8XkBZGXiyEuv0GLxStlqd4A6nKQuiRJMV76QWyigdqil-mi2syLkfoPTzmyDg" },
  WANTED_10K: { manifest_sha256: "fe247263b9b006a4f99a816c8e158d45daefe176ad352a1b2e49bcaa013fac10", auditor_signature: "6Il5ZwYGnO8dKSwN4SzNpDwcjwWaMuiBpXWJLEYvQksBRjhzmc7dEUK-iEwxuiKyB1-0esmZMGJki9w9SoI_Dw" },
};
