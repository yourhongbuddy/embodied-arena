...
const auditManifestTemplateBase = {
  ...
  audit: { profile_version: "0.2-V1", auditor: "Synthetic Auditor", auditor_organization: "Independent Example Assurance", independence_statement: "Synthetic example: auditor is organizationally and financially independent of the sponsor.", scope: ["Preregistration", "Telemetry continuity", "Endpoint dispositions", "Safety evidence", "Score reproduction", "Withdrawal integrity", "Human measures integrity", "Learning and generalization integrity", "Assistance integrity", "Policy evolution integrity", "Privacy and consent integrity"], signed_at: "2026-08-28T18:00:00Z", signature_algorithm: "Ed25519", canonicalization: "RFC8785_JCS", signature_scope: "audit_manifest_without_audit.manifest_sha256_and_audit.auditor_signature", public_key_uri: "https://embodied-arena.chrishongap.chatgpt.site/wanted-10k/auditor-credential.template.json", public_key_base64url: "11qYAYKxCrfVS_7TyWQHOg7hcvPapiMlrwIaaPcHURo", public_key_sha256: "21fe31dfa154a261626bf854046fd2271b7bed4b6abe45aa58877ef47f9721b9", credential: auditorCredentialTemplate, manifest_sha256: hash("a1"), auditor_signature: "A".repeat(86) },
};

const na = (reason: string) => ({ applicable: false as const, reason });
const syntheticAuditSeals = {
  PREQUALIFIED: { manifest_sha256: "1f8e37ef56e7550a3b71805a355ef8f6810f8f570af0ca8d397e3479298b540a", auditor_signature: "eB5N3VPXbUl9jeeXyXO6f6qrEp-zH1DCOL-xHrvUKJjK6rcSJNnoKBuF4dETSLt-9JV62lkuhGwYfcFipmwoDg" },
  WANTED_LAB: { manifest_sha256: "69742571bf8b938bc439cef94b41ebdb8ba6aab02e935aef36244f53622ff303", auditor_signature: "OnBIx65puCEWJ8gM5LEhRPP7m_blZsCYuZylRKLnWjVQL_RxBqulbq8x_VkCiJ4CEyJM4gf45MvqwDdGyiSuCA" },
  WANTED_WILD: { manifest_sha256: "920c42e1b456ad4ea7697fc31e40ee25a37eac952399bad91e8899473d050ac9", auditor_signature: "3MaCuYihqyamvg_AsuEN0pzF3tAtAV2zH02U-fZ02aJxYfijvK7NQVkyWAj_j3JTDXC_DXNJe105eSjhYlRzCw" },
  WANTED_10K: { manifest_sha256: "5f3e009ad6f938892ac8658655afee7ce2af530fc2cd8b51e4f95bbfce349940", auditor_signature: "DFVTzHTlwTqv5cuN3P-6-Sj66a-zraufNSu_cKFlKcrars7jUR_R_YdQUvhVj-yzvRyApq9Y91UICZyuG2HfAw" },
};
