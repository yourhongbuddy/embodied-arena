...
export default function AuditPage() {
  return <main className="auditPage">
    ...
    <section className="auditHero shell">
      ...
      <p>A leaderboard score should never be a loose spreadsheet entry. The WANTED Audit Pack binds the public row to frozen study rules, robot versions, cohort results, safety evidence, telemetry commitments, endpoint decisions, and independent sign-off.</p>
