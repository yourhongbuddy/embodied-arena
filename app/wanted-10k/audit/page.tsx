...
export default function AuditPage() {
  return <main className="auditPage">
    ...
    <section className="auditHero shell">
      ...
      <p>A certification claim should never be a loose spreadsheet entry. The WANTED Audit Pack applies the evidence gates for the selected target, then binds each applicable claim to frozen study rules, cohort selection and independence, signed resident-clock reconciliation, event-by-event Ed25519 verification, reproducible survival analysis, robot and policy artifacts, results, and independent sign-off.</p>
