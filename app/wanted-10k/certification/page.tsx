...
const levels = [
  ...
  ["02", "WANTED LAB", "1 SITE / 100H", "Add cohort integrity, exposure-ledger integrity, neutral human measures 0.2-H1, matched learning 0.2-LG1, assistance integrity 0.2-I1, policy evolution 0.2-U1, privacy + consent integrity 0.2-PV1, field safety, cryptographically verified telemetry 0.2-T1, endpoint adjudication, diagnostics, and a lab report. No cohort W is claimed."],
