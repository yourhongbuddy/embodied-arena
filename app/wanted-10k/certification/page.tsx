...
const levels = [
  ["01", "PREQUALIFIED", "SIMULATION", "Verify preregistration freeze and amendment integrity 0.2-PR1, then pass the 0.2-P1 preflight before human exposure. Field W, diagnostics, safety telemetry, and endpoint adjudication are explicitly not applicable."],
