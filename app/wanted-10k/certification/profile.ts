export const certificationProfile = {
  ...
  targets: {
    PREQUALIFIED: {
      ...
      requires: ["identity_and_version_binding", "preregistration_integrity_0.2-PR1", "protocol_deviation_integrity_0.2-DV1", "preflight_0.2-P1", "simulation_report", "independent_audit_seal_0.2-V1", "auditor_credential_0.2-V2"],
    ...
    WANTED_10K: {
      ...
      inherits: ["WANTED_LAB"],
      requires: ["preregistration_integrity_0.2-PR1", "protocol_deviation_integrity_0.2-DV1", "one_lifetime_completion", "endpoint_adjudication_0.2-J1", "human_measures_0.2-H1", "learning_generalization_0.2-LG1", "assistance_integrity_0.2-I1", "policy_evolution_integrity_0.2-U1", "privacy_integrity_0.2-PV1", "service_continuity_0.2-SC1", "withdrawal_0.2-W1", "seven_day_withdrawal", "reacquisition_result", "independent_audit_seal_0.2-V1", "auditor_credential_0.2-V2"],
