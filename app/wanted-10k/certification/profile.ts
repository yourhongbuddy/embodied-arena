export const certificationProfile = {
  ...
  targets: {
    PREQUALIFIED: {
      ...
      requires: ["identity_and_version_binding", "frozen_preregistration", "preflight_0.2-P1", "simulation_report", "independent_audit_seal_0.2-V1"],
    ...
    WANTED_LAB: {
      ...
      requires: ["cohort_integrity_0.2-E1", "exposure_ledger_0.2-X1", "field_safety_0.2-S1", "telemetry_authenticity_0.2-T1", "diagnostics_0.2-D1", "endpoint_adjudication", "lab_report", "independent_audit_seal_0.2-V1"],
    ...
    WANTED_WILD: {
      ...
      inherits: ["WANTED_LAB"],
      requires: ["analysis_reproduction_0.2-A1", "identifiable_primary_W", "cluster_bootstrap_95CI", "robustness_0.2-R1", "tail_support", "independent_audit_seal_0.2-V1"],
      rankable: true,
    },
    WANTED_10K: {
      ...
      inherits: ["WANTED_LAB"],
      requires: ["one_lifetime_completion", "seven_day_withdrawal", "reacquisition_result", "independent_audit_seal_0.2-V1"],
