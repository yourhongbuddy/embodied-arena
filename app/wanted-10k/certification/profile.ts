export const certificationProfile = {
  ...
  targets: {
    PREQUALIFIED: {
      ...
      not_applicable: ["cohort_integrity_0.2-E1", "exposure_ledger_0.2-X1", "analysis_reproduction_0.2-A1", "human_measures_0.2-H1", "withdrawal_0.2-W1", "telemetry_authenticity_0.2-T1", "primary_W", "diagnostics_0.2-D1", "field_safety_0.2-S1", "field_telemetry", "endpoint_adjudication"],
      rankable: false,
    },
    WANTED_LAB: {
      ...
      requires: ["cohort_integrity_0.2-E1", "exposure_ledger_0.2-X1", "human_measures_0.2-H1", "field_safety_0.2-S1", "telemetry_authenticity_0.2-T1", "diagnostics_0.2-D1", "endpoint_adjudication", "lab_report", "independent_audit_seal_0.2-V1", "auditor_credential_0.2-V2"],
    ...
    WANTED_WILD: {
      ...
      inherits: ["WANTED_LAB"],
      requires: ["analysis_reproduction_0.2-A1", "human_measures_0.2-H1", "withdrawal_0.2-W1_if_lifetime_completions", "identifiable_primary_W", "cluster_bootstrap_95CI", "robustness_0.2-R1", "tail_support", "independent_audit_seal_0.2-V1", "auditor_credential_0.2-V2"],
      rankable: true,
    },
    WANTED_10K: {
      ...
      inherits: ["WANTED_LAB"],
      requires: ["one_lifetime_completion", "human_measures_0.2-H1", "withdrawal_0.2-W1", "seven_day_withdrawal", "reacquisition_result", "independent_audit_seal_0.2-V1", "auditor_credential_0.2-V2"],
