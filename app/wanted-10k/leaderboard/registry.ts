...
export const leaderboardContract = {
  ...
  admission: ["audit_manifest_passes_all_six_gates", "WANTED_WILD_certification_awarded", "horizon_identifiable", "bootstrap_valid_fraction_at_least_0.95", "preflight_and_safety_pass", "L4_equals_zero", "public_aggregate_evidence_pack", "independent_auditor_signature"],
