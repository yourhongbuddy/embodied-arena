...
export const leaderboardContract = {
  ...
  admission: ["audit_manifest_passes_all_six_gates", "WANTED_WILD_certification_awarded", "horizon_identifiable", "bootstrap_valid_fraction_at_least_0.95", "preflight_profile_0.2-P1_passes", "safety_profile_0.2-S1_passes", "L4_equals_zero", "public_aggregate_evidence_pack", "independent_auditor_signature"],
