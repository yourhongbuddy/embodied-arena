...
export const leaderboardContract = {
  ...
  ranking: {
    ...
    forbidden_tiebreakers: ["confidence_interval_width", "safety_incidents", "assistance_burden", "participant_labor", "teleoperation", "maintenance", "availability", "MTBHR", "human_keep_value_burden_trust", "learning_delta", "generalization_ratio", "policy_update_count", "policy_changed_exposure", "rollout_lag", "reservation_value", "reacquisition", "certification_badges"],
  ...
  admission: ["audit_manifest_passes_all_six_gates", "WANTED_WILD_certification_awarded", "cohort_integrity_profile_0.2-E1_passes", "exposure_ledger_profile_0.2-X1_passes", "analysis_reproduction_profile_0.2-A1_passes", "human_measures_profile_0.2-H1_passes", "learning_generalization_profile_0.2-LG1_passes", "assistance_integrity_profile_0.2-I1_passes", "policy_evolution_integrity_profile_0.2-U1_passes", "withdrawal_profile_0.2-W1_when_lifetime_completions_exist", "telemetry_authenticity_profile_0.2-T1_passes", "independent_audit_seal_profile_0.2-V1_passes", "auditor_credential_profile_0.2-V2_passes", "horizon_identifiable", "bootstrap_valid_fraction_at_least_0.95", "preflight_profile_0.2-P1_passes", "safety_profile_0.2-S1_passes", "L4_equals_zero", "public_aggregate_evidence_pack"],
