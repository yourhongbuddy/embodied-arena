...
export const leaderboardContract = {
  ...
  ranking: {
    ...
    forbidden_tiebreakers: ["confidence_interval_width", "safety_incidents", "preregistration_amendment_count", "sampling_target_or_overshoot", "protocol_deviation_count", "site_heterogeneity_metrics", "assistance_burden", "participant_labor", "teleoperation", "maintenance", "availability", "service_continuity_metrics", "endpoint_review_metrics", "MTBHR", "human_keep_value_burden_trust", "learning_delta", "generalization_ratio", "policy_update_count", "policy_changed_exposure", "rollout_lag", "privacy_metrics", "reservation_value", "reacquisition", "certification_badges"],
