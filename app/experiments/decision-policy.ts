...
export function evaluateExperimentDecisionPolicy(value:unknown):ExperimentDecisionPolicyResult{
  ...
  const eligible=bundle.evidence_purpose==="production";
  if(!eligible)reasons.push("Synthetic conformance evidence cannot be decision eligible.");
  return result("pass",outcome,recommended,eligible,qualifying,[],reasons);
}
