...
import { EXPERIMENT_ANALYSIS_COHORT,ROTATOR_VERSION,WANTED_LANDING_EXPERIMENT } from "./rotator";
...
type Data={status:"ready"|"unavailable";experiment:string;analysis_cohort:string;implementation_version:string;window_days:number;primary_goal:string;total_exposed_units:number;cross_variant_units_excluded:number;multi_token_units_excluded:number;decision_gate:DecisionGate;sample_ratio_mismatch:RatioCheck;variants:Row[];comparisons:Comparison[]};
