...
type Data={status:"ready"|"unavailable";experiment:string;analysis_cohort:string;treatment_fingerprint:string;implementation_version:string;analysis_unit:"experiment_scoped_anonymous_browser_unit";unit_represents:"one_first_party_browser_profile_storage_instance";reported_as_unique_users:false;human_identity_resolution:false;window_days:number;primary_goal:string;total_exposed_units:number;cross_variant_units_excluded:number;multi_token_units_excluded:number;decision_gate:DecisionGate;sample_ratio_mismatch:RatioCheck;variants:Row[];comparisons:Comparison[]};
