...
export const ROTATOR_VERSION = "0.27-R27";
export const EXPERIMENT_ANALYSIS_COHORT = "wanted_landing_v1-C7";
export const EXPERIMENT_ANALYSIS_COHORT_START_VERSION = "0.27-R27";
