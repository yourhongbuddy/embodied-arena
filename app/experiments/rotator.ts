...
export const ROTATOR_VERSION = "0.22-R22";
...
export const experimentRotatorContract = {
  ...
  receipt_diagnostics: { profile: "0.22-RD1", route: "/api/experiments", window_days: 30, receipt_cutoff_basis: "expires_at_index_with_29_day_cutoff_for_24_hour_receipts", metrics: ["issued_receipts","issued_units","exposed_receipts","unexposed_receipts","active_unexposed_receipts","expired_unexposed_receipts","duplicate_identity_receipts","receipt_to_exposure_rate"], thresholds: null, decision_effect: "none", counts_rejected_requests: false, proves_human_traffic: false },
