...
export const ROTATOR_VERSION = "0.35-R35";
...
export const EXPERIMENT_ACTIVE_COHORT_EVENT_VERSIONS=["0.28-R28","0.29-R29","0.30-R30","0.31-R31","0.32-R32","0.33-R33","0.34-R34","0.35-R35"] as const;
...
export const experimentRotatorContract = {
  ...
  decision_design_lab: { profile: "0.34-DL1", route: "/experiments/design-lab", contract: "/experiments/design-lab.json", plan_schema: "/experiments/design-plan.schema.json", reference_plan: "/experiments/design-plan.reference.json", verifier: { profile: "0.35-DPV1", module: "/experiments/wanted-design-plan.mjs", contract: "/experiments/design-plan-verifier.json", runtime_dependencies: 0, performs_network_requests: false }, design: "fixed_horizon_two_independent_proportions", comparison_count: 2, multiplicity: "bonferroni_two_sided_familywise", sample_size_method: "normal_approximation_unequal_allocation", canonicalization: "sorted_key_recursive_json", digest: "SHA-256", sends_analytics: false, changes_live_allocation: false, changes_live_assignment: false, changes_decision_gate: false, preregisters_plan: false, selects_version: false },
