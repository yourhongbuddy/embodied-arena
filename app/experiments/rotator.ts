...
export const ROTATOR_VERSION = "0.32-R32";
...
export const EXPERIMENT_ACTIVE_COHORT_EVENT_VERSIONS=["0.28-R28","0.29-R29","0.30-R30","0.31-R31","0.32-R32"] as const;
...
export const experimentRotatorContract = {
  ...
  assignment_sdk: { version: EXPERIMENT_ROTATOR_SDK_VERSION, module: "/experiments/wanted-rotator.mjs", contract: "/experiments/rotator-sdk.json", source_digest_field: "source_sha256", runtime_dependencies: 0, performs_network_requests: false, conformance_vectors: EXPERIMENT_ROTATOR_CONFORMANCE_VECTORS, changes_assignment: false, issues_server_receipt: false, authenticates_traffic: false },
