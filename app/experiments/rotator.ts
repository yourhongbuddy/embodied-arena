...
export const ROTATOR_VERSION = "0.23-R23";
...
export const experimentRotatorContract = {
  ...
  receipt_diagnostics: { profile: "0.23-RD2", route: "/api/experiments", window_days: 30, receipt_cutoff_basis: "expires_at_index_with_29_day_cutoff_for_24_hour_receipts", grouping: "assigned_version", metrics: ["issued_receipts","issued_units","exposed_receipts","exposed_units","unexposed_receipts","active_unexposed_receipts","expired_unexposed_receipts","duplicate_session_unit_receipts","receipt_to_exposure_rate","unit_to_exposure_rate"], issuance_sample_ratio_mismatch: { method: "pearson_chi_square_df_2", alert_p_below: .001 }, unit_delivery_balance: { method: "pearson_chi_square_homogeneity_df_2", alert_p_below: .001 }, thresholds_are_operational_alerts_only: true, decision_effect: "none", counts_rejected_requests: false, proves_human_traffic: false },
