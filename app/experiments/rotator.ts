...
export const ROTATOR_VERSION = "0.24-R24";
export const EXPERIMENT_ANALYSIS_COHORT = "wanted_landing_v1-C6";
export const EXPERIMENT_ANALYSIS_COHORT_START_VERSION = "0.21-R21";
...
export const experimentRotatorContract = {
  ...
  receipt_diagnostics: { profile: "0.24-RD3", route: "/api/experiments", window_days: 30, receipt_followup_hours: 24, receipt_cutoff_basis: "expires_at_index_with_29_day_cutoff_for_24_hour_receipts", grouping: "assigned_version", unit_receipt_basis: "first_retained_receipt_per_unit", maturity_rule: "first_retained_receipt_expires_at_lte_results_read_time", delivery_balance_basis: "matured_browser_units_only", metrics: ["issued_receipts","issued_units","exposed_receipts","exposed_units","matured_units","matured_exposed_units","pending_maturity_units","unexposed_receipts","active_unexposed_receipts","expired_unexposed_receipts","duplicate_session_unit_receipts","receipt_to_exposure_rate","unit_to_exposure_rate","matured_unit_delivery_rate"], issuance_sample_ratio_mismatch: { method: "pearson_chi_square_df_2", alert_p_below: .001 }, unit_delivery_balance: { method: "pearson_chi_square_homogeneity_df_2", alert_p_below: .001 }, thresholds_are_operational_alerts_only: true, decision_effect: "none", counts_rejected_requests: false, proves_human_traffic: false },
