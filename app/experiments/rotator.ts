export const ROTATOR_VERSION = "0.18-R18";
export const EXPERIMENT_ANALYSIS_COHORT = "wanted_landing_v1-C3";
export const EXPERIMENT_ANALYSIS_COHORT_START_VERSION = "0.18-R18";
