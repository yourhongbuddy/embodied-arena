export const ROTATOR_VERSION = "0.17-R17";
...
export const experimentRotatorContract = {
  ...
  privacy: { persistent_identifier: "experiment_scoped_random_assignment_id", transmitted_identifier: "experiment_unit_session_and_exposure_token", assignment_id_contains_user_attributes: false, separate_device_identifier: false, identifies_person: false, identifies_household: false, identifies_device: false, unit_id_scope: WANTED_LANDING_EXPERIMENT.id, unit_id_cross_experiment_linkage: false, browser_storage_partitioning_may_create_multiple_units: true, IP_storage: false, fingerprinting: false, third_party_analytics: false, event_retention_days: 35, deletion_mechanism: "delete_before_each_accepted_insert_and_results_read", deletion_triggers: ["accepted_insert","analytics_summary_read","experiment_results_read"] },
  assignment: { unit: "experiment_scoped_anonymous_browser_unit", unit_represents: "one_first_party_browser_profile_storage_instance", assignment_material: "random_experiment_scoped_unit_id", persistence_storage: "first_party_local_storage", persistence_write_readback_required: true, storage_unavailable_behavior: "control_or_named_preview_excluded", server_recomputable: true, analysis_unit_matches_assignment_unit: true, algorithm: "FNV1a_32", modulus: 10_000, stable_per_device: false, stable_per_browser_profile_storage: true, stable_per_session: true, stable_after_storage_clear: false, stable_across_private_browsing_sessions: false, cross_browser_identity_resolution: false, cross_device_identity_resolution: false, human_identity_resolution: false, unit_regeneration_conditions: ["site_data_cleared","private_browsing_session_recreated","different_browser_profile","different_device"], session_lock_scope: "analysis_cohort_experiment", one_assigned_variant_per_session: true, one_assigned_variant_per_unit: true, query_override: "wanted_variant", invalid_override: "ignored", pre_assignment_presentation: "neutral_noninteractive" },
