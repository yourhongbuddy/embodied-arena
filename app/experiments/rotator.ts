...
export const experimentRotatorContract = {
  ...
  rollout_phase_ledger: { profile: "0.42-RPL1", lab: "/experiments/rollout-lab", module: "/experiments/wanted-rollout-phase-ledger.mjs", contract: "/experiments/rollout-phase-ledger.json", schema: "/experiments/rollout-phase-ledger.schema.json", reference_bundle: "/experiments/rollout-phase-ledger.reference.json", analysis_use: "operational_safety_only_excluded_from_version_selection", authorization_refresh_required_each_phase: true, runtime_dependencies: 0, performs_network_requests: false, private_key_input_supported: false, automatic_progression: false, changes_live_allocation: false, deploys: false },
  rollout_simulator: { profile: "0.43-RSM1", lab: "/experiments/rollout-simulator", contract: "/experiments/rollout-simulator.json", schema: "/experiments/rollout-simulator.schema.json", reference_bundle: "/experiments/rollout-simulator.reference.json", analysis_use: "synthetic_preproduction_only_excluded_from_exposure_and_version_selection", monotone_membership_required: true, runtime_dependencies: 0, performs_network_requests: false, creates_identifiers: false, sends_analytics: false, counts_exposures: false, supports_version_selection: false, changes_live_allocation: false, deploys: false },
  rollout_config_compiler: { profile: "0.44-RCC1", manifest_profile: "0.44-RCM1", lab: "/experiments/rollout-simulator", module: "/experiments/wanted-rollout-config.mjs", contract: "/experiments/rollout-config.json", schema: "/experiments/rollout-config.schema.json", reference_bundle: "/experiments/rollout-config.reference.json", manual_confirmation_required: true, automatic_application: false, contains_secrets: false, runtime_dependencies: 0, performs_network_requests: false, applies_configuration: false, changes_live_allocation: false, changes_live_phase: false, deploys: false },
  rollout_runtime_resolver: { profile: "0.45-RRR1", lab: "/experiments/rollout-simulator", module: "/experiments/wanted-rollout-runtime.mjs", contract: "/experiments/rollout-runtime.json", schema: "/experiments/rollout-runtime.schema.json", reference_vectors: "/experiments/rollout-runtime.reference.json", invalid_configuration_behavior: "control_fallback_with_no_bucket_or_phase", assignment_mode: "synthetic_preview", runtime_dependencies: 0, reads_platform_environment: false, writes_browser_storage: false, performs_network_requests: false, live_use_eligible: false, treatment_served: false, exposure_counted: false, changes_live_allocation: false, changes_live_phase: false, deploys: false },
  rollout_bucket_conformance: { profile: "0.46-RBC1", certificate_profile: "0.46-RBCERT1", lab: "/experiments/rollout-simulator", module: "/experiments/wanted-rollout-bucket-conformance.mjs", contract: "/experiments/rollout-bucket-conformance.json", schema: "/experiments/rollout-bucket-conformance.schema.json", reference_certificate: "/experiments/rollout-bucket-conformance.reference.json", buckets_enumerated: 10_000, exact_phase_counts: [500, 2_500, 5_000, 10_000], newly_selected_counts: [500, 2_000, 2_500, 5_000], rollback_selected_count: 0, rollback_control_count: 10_000, runtime_dependencies: 0, reads_user_identifiers: false, reads_platform_environment: false, performs_network_requests: false, uses_live_traffic: false, counts_exposures: false, supports_version_selection: false, changes_live_allocation: false, changes_live_phase: false, deploys: false },
  rollout_distribution_audit: { profile: "0.48-RDA2", certificate_profile: "0.48-RDAC2", generator_profile: "0.43-RSM1", audited_source_sha256: "aef89bad20c04d1bee8e65af5064606e42ae1dda4ff5e061f707c0a99a7656f3", cross_implementation_vector_count: 16, lab: "/experiments/rollout-simulator", module: "/experiments/wanted-rollout-distribution.mjs", contract: "/experiments/rollout-distribution.json", schema: "/experiments/rollout-distribution.schema.json", reference_certificate: "/experiments/rollout-distribution.reference.json", sample_size: 1_000_000, buckets: 10_000, expected_units_per_bucket: 100, reads_user_identifiers: false, reads_platform_environment: false, performs_network_requests: false, uses_live_traffic: false, counts_exposures: false, supports_version_selection: false, changes_live_allocation: false, changes_live_phase: false, deploys: false },
