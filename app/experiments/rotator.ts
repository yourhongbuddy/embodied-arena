export const ROTATOR_VERSION = "0.9-R9";
...
export const experimentRotatorContract = {
  ...
  counting: { exposure: "once_per_session_per_experiment_variant", goal: "distinct_exposed_sessions_with_matching_exposure_token_primary_cta", receipt_order_dependency: false, cross_variant_sessions_excluded: true, preview_mode_included: false, operator_mode_included: false, reporting_window_days: 30 },
