export const ROTATOR_VERSION = "0.1-R1";
...
export const experimentRotatorContract = {
  ...
  privacy: { persistent_identifier: "device_local_only", transmitted_identifier: "ephemeral_session_only", IP_storage: false, fingerprinting: false, third_party_analytics: false },
  assignment: { algorithm: "FNV1a_32", modulus: 10_000, stable_per_device: true, query_override: "wanted_variant", invalid_override: "ignored" },
  counting: { exposure: "once_per_session_per_experiment_variant", goal: "distinct_sessions_with_primary_cta", preview_mode_included: false, reporting_window_days: 30 },
