export const ROTATOR_VERSION = "0.19-R19";
export const EXPERIMENT_ANALYSIS_COHORT = "wanted_landing_v1-C4";
export const EXPERIMENT_ANALYSIS_COHORT_START_VERSION = "0.19-R19";
