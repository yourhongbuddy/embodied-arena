export const ROTATOR_VERSION = "0.10-R10";
...
export const experimentRotatorContract = {
  ...
  assignment: { algorithm: "FNV1a_32", modulus: 10_000, stable_per_device: true, stable_per_session: true, session_lock_scope: "rotator_version_experiment", one_assigned_variant_per_session: true, query_override: "wanted_variant", invalid_override: "ignored", pre_assignment_presentation: "neutral_noninteractive" },
  ...
  counting: { exposure: "one_unique_exposure_token_per_session", goal: "distinct_exposed_sessions_with_matching_exposure_token_primary_cta", event_path: "/wanted-10k", query_path_required: true, duplicate_events_with_same_token_deduplicated: true, one_exposure_token_per_counted_session: true, receipt_order_dependency: false, cross_variant_sessions_excluded: true, multi_token_sessions_excluded: true, integrity_exclusions_disclosed: true, preview_mode_included: false, operator_mode_included: false, reporting_window_days: 30 },
