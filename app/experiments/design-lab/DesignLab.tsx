...
export function DesignLab(){
  ...
  return <section className="designLabWorkspace shell">
    ...
    <section className="designFreeze">
      ...
      <div className="designFreezeActions"><button type="button" onClick={copy} disabled={!valid}>{copyStatus==="copied"?"COPIED":copyStatus==="failed"?"COPY FAILED":"COPY CANONICAL PLAN"}</button><button type="button" onClick={download} disabled={!valid}>DOWNLOAD PLAN.JSON</button><a href="/experiments/wanted-design-plan.mjs">PLAN VERIFIER ↗</a><a href="/experiments/registration-lab">RECEIPT LAB ↗</a><a href="/experiments/wanted-design-registration.mjs">RECEIPT SDK ↗</a><a href="/experiments/design-plan.schema.json">PLAN SCHEMA ↗</a><a href="/experiments/design-plan.reference.json">PLAN VECTOR ↗</a><a href="/experiments/design-lab.json">MACHINE CONTRACT ↗</a></div>
