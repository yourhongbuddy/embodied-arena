...
const links = [
  ["/scan","Scan"],["/wanted-10k","WANTED-10K"],["/wanted-10k/realtime","Realtime"],["/leaderboard","Leaderboard"],["/arenagpt","ArenaGPT"],["/agents","Agents"],["/monitoring","Monitor"],["/watch","Watch"],["/atlas","Atlas"],["/campaigns","Campaigns"],["/analytics","Heartbeat"],
];
