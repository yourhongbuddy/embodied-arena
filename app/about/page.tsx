...
export default function AboutPage() {
  return <CompanyPage title="About us" intro="A place to understand robot intelligence through tools, context, and evidence.">
    <div className="companyCallout"><h2>Build your own comparison</h2><p><a href="/studio">Benchmark Studio</a> lets people and their agents create private benchmarks, import results, and export bar, line, and scatter charts. Start with an example or bring your own measurements.</p></div>
    <h2>A wider view with Robot Dispatch</h2><p><a href="/news">Robot Dispatch</a> brings together headlines and links to original reporting across world news, politics, markets, technology, science, culture, and sports. It is an independently branded Robot Router experience, inspired by a news-feed format and not affiliated with IJR. Ask Robot, our AI question assistant, is available throughout the site when its AI service is activated.</p>
