...
test("publishes a stable privacy-first site version rotator",async()=>{
  ...
  assert.match(pageHtml,/VERSION DELIVERY INTEGRITY/);assert.match(pageHtml,/ASSIGNMENT DELIVERY/);assert.match(pageHtml,/operational alerts only and cannot select or stop a version/i);
  ...
  assert.match(pageHtml,/Per-version final rates include marginal Wilson 95% intervals/i);
