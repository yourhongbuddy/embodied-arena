...
test("publishes a stable privacy-first site version rotator",async()=>{
  ...
  const metadata={experiment:"wanted_landing_v1",analysis_cohort:"wanted_landing_v1-C6",treatment_fingerprint:contract.analysis_cohort.treatment_fingerprint,presentation_fingerprint:contract.analysis_cohort.presentation_fingerprint,assignment_receipt:"88888888-8888-4888-8888-888888888888",unit_id:unit,variant:assignment.variant,assignment_mode:"assigned",rotator_version:"0.26-R26",exposure_id:token};
