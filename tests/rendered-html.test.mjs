...
test("publishes a stable privacy-first site version rotator",async()=>{
  ...
  assert.match(pageHtml,/ANALYSIS WINDOW/);assert.match(pageHtml,/exact inclusive 30-day D1 database-UTC window/i);assert.match(pageHtml,/unavailable results do not invent a window/i);
