...
test("publishes a stable privacy-first site version rotator",async()=>{
  ...
  const metadata={experiment:"wanted_landing_v1",analysis_cohort:"wanted_landing_v1-C2",treatment_fingerprint:contract.analysis_cohort.treatment_fingerprint,unit_id:unit,variant:assignment.variant,assignment_mode:"assigned",rotator_version:"0.16-R16",exposure_id:token};
