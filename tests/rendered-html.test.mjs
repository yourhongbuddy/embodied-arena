...
test("publishes a stable privacy-first site version rotator",async()=>{
  ...
  const metadata={experiment:"wanted_landing_v1",unit_id:unit,variant:assignment.variant,assignment_mode:"assigned",rotator_version:"0.12-R12",exposure_id:token};
