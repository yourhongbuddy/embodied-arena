...
test("portable verifier rejects mathematical, field, digest, and I-JSON drift",async()=>{
  ...
  const version=structuredClone(plan);version.rotator_version="0.36-R36";assert.equal((await verify(version)).status,"fail");
