...
const entry = (submission_id, public_label, wanted_score, overrides = {}) => ({
  registry_profile_version: "0.2-L1", submission_id, study_id: `study-${submission_id}`, cohort_id: `cohort-${submission_id}`, public_label, manufacturer: "Example Robotics", model: "H1", hardware_version: "1.0", policy_version: "1.0", policy_artifact_sha256: hash("a1"), certifications: ["PREQUALIFIED", "WANTED_LAB", "WANTED_WILD"], registry_status: "active", wanted_score, ci95_lower: Math.max(0, wanted_score - 5), ci95_upper: Math.min(100, wanted_score + 5), survival_at_10000: .6, independent_environments: 24, total_resident_hours: 120000, support_at_10000: 8, censoring_bound_width: 12.4, assistance_minutes_per_100_hours: 18.2, assistance_integrity_verified: true, assistance_ci95_lower: 15, assistance_ci95_upper: 21, assisted_exposure_fraction: .003, participant_labor_minutes_per_100_hours: 2.1, teleoperation_minutes_per_100_hours: 4.2, maintenance_minutes_per_100_hours: 7.4, researcher_contact_minutes_per_100_hours: 0, human_rescue_events: 280, human_measure_completion_rate: .92, human_keep_rate: .84, human_value_median: 1, human_burden_median: 1, human_trust_median: 3, learning_generalization_verified: true, learning_paired_environments: 23, learning_trial_completion_rate: .995, learning_delta_familiar: .18, learning_delta_ci95_lower: .08, learning_delta_ci95_upper: .28, late_generalization_ratio: .86, revealed_preference: { status: "not_run" }, mean_time_between_human_rescue_hours: 428.57, mean_time_between_human_rescue_lower_bound_hours: null, l4_incidents: 0, safety_gate_status: "passed", audit_manifest_uri: `https://example.org/${submission_id}.json`, audit_manifest_sha256: hash("b2"), audit_signed_at: "2026-08-28T18:00:00Z", published_at: "2026-08-28T19:00:00Z", supersedes_submission_id: null, ...overrides,
});
