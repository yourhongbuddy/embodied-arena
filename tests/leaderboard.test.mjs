...
test("does not use safety, burden, or badges as tiebreakers", () => {
  const result = rankRegistry([entry("s1", "Alpha", 80.01, { assistance_minutes_per_100_hours: 200 }), entry("s2", "Beta", 80.04, { assistance_minutes_per_100_hours: 1, certifications: ["PREQUALIFIED", "WANTED_LAB", "WANTED_WILD", "WANTED_10K"] })]);
